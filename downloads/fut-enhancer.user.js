...
var _settingsEntry = __webpack_require__(344);

var _baseScript = __webpack_require__(345);

var _db = __webpack_require__(93);

var _queue = __webpack_require__(346);

var _browser = __webpack_require__(352);
...
var _logger = __webpack_require__(131);

var _pinEvent = __webpack_require__(132);

var _store = __webpack_require__(347);

var _transferMarket = __webpack_require__(348);

var _club = __webpack_require__(351);

var _utils = __webpack_require__(133);

var _utils2 = _interopRequireDefault(_utils);

var _priceTiers = __webpack_require__(134);
...
var _eventEmitterEs = __webpack_require__(343);
...
exports.default = {
  roundValueToNearestPriceTiers: function roundValueToNearestPriceTiers(value) {
    var tier = utils.JS.find(components.NumericInput.PRICE_TIERS, function (i) {
      return value > i.min;
    });
...
var _settings = __webpack_require__(338);

var _settings2 = _interopRequireDefault(_settings);

var _core = __webpack_require__(21);

var _fut = __webpack_require__(43);

var _transferlist = __webpack_require__(353);

var _futbin = __webpack_require__(362);

var _club = __webpack_require__(367);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

gAuthenticationModel.addListener(models.AuthenticationModel.EVENT_AUTHENTICATION_SUCCESSFUL, undefined, function () {
  ...
  settings.registerEntry(new _transferlist.RemoveSoldAuctionsSettings());
  settings.registerEntry(new _transferlist.RelistAuctionsSettings());
  ...
  settings.registerEntry(new _club.ClubInfoSettings());
...
var _settings = __webpack_require__(342);
      ...
      try {
        for (var _iterator2 = entry.settings[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          if (setting.subsettings.length > 0) {
            var subChecked = setting.value ? 'checked="checked"' : '';
...
var SettingsEntry = exports.SettingsEntry = function () {
  ...
  _createClass(SettingsEntry, [{
    ...
    key: 'addSetting',
    value: function addSetting(label, key, defaultValue, cb) {
      var settings = _db.Database.getJson('settings:' + this.id, {});
    ...
    key: 'addSettingUnder',
    value: function addSettingUnder(underKey, label, key, defaultValue, cb) {
      var settings = _db.Database.getJson('settings:' + this.id, {});
      settings[key] = key in settings ? settings[key] : defaultValue;
      _db.Database.setJson('settings:' + this.id, settings);
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /* global gNavManager */
...
var BaseScript = exports.BaseScript = function () {
  function BaseScript(id) {
    ...
    _settings.Settings.getInstance().on('entry-enabled', function (entry) {
      if (entry.id === id) {
        _this.screenRequestObserver = gNavManager.onScreenRequest.observe(_this, function (obs, event) {
          var _this2 = this;
...
var _mathStatistics = __webpack_require__(349);
...
var _errors = __webpack_require__(350);
        ...
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 3:
                _context6.next = 5;
                return _utils2.default.sleep(5000);
    ...
    value: function _defineSearchCriteria(item) {
      ...
      if (item.rareflag >= enums.ItemRareType.TOTW) {
        searchCriteria.level = factories.DataProvider.getItemLevelDP(true).filter(function (d) {
          return d.id === enums.ItemRareType.TOTW;
        })[0].value;
      }
...
exports.ListSizeSettings = exports.MinBinSettings = exports.RemoveSoldAuctionsSettings = exports.RelistAuctionsSettings = exports.RefreshListSettings = exports.CardInfoSettings = undefined;

var _refreshList = __webpack_require__(354);

var _removeSold = __webpack_require__(355);

var _minBin = __webpack_require__(356);

var _relistExpired = __webpack_require__(357);

var _cardInfo = __webpack_require__(358);

var _listSize = __webpack_require__(361);

exports.CardInfoSettings = _cardInfo.CardInfoSettings;
exports.RefreshListSettings = _refreshList.RefreshListSettings;
exports.RelistAuctionsSettings = _relistExpired.RelistAuctionsSettings;
...
exports.RemoveSoldAuctionsSettings = undefined;
...
var RemoveSoldAuctionsSettings = exports.RemoveSoldAuctionsSettings = function (_SettingsEntry) {
  _inherits(RemoveSoldAuctionsSettings, _SettingsEntry);

  function RemoveSoldAuctionsSettings() {
    _classCallCheck(this, RemoveSoldAuctionsSettings);

    var _this = _possibleConstructorReturn(this, (RemoveSoldAuctionsSettings.__proto__ || Object.getPrototypeOf(RemoveSoldAuctionsSettings)).call(this, 'remove-sold-auctions', 'Remove sold auctions automatically', null));

    _this.addSetting('Interval in seconds', 'interval', 60);
    _this.addSetting('IFTTT Key', 'ifttt-key', '');
    return _this;
  }

  return RemoveSoldAuctionsSettings;
}(_core.SettingsEntry);

RemoveSoldAuctionsSettings.id = 'remove-sold-auctions';

var RemoveSoldAuctions = function (_BaseScript) {
  _inherits(RemoveSoldAuctions, _BaseScript);

  function RemoveSoldAuctions() {
    _classCallCheck(this, RemoveSoldAuctions);

    var _this2 = _possibleConstructorReturn(this, (RemoveSoldAuctions.__proto__ || Object.getPrototypeOf(RemoveSoldAuctions)).call(this, RemoveSoldAuctionsSettings.id));

    var MutationObserver = window.MutationObserver || window.WebKitMutationObserver;
    _this2._observer = new MutationObserver(RemoveSoldAuctions._mutationHandler.bind(_this2));
    return _this2;
  }

  _createClass(RemoveSoldAuctions, [{
    key: 'activate',
    value: function activate(state) {
      var _this3 = this;

      _get(RemoveSoldAuctions.prototype.__proto__ || Object.getPrototypeOf(RemoveSoldAuctions.prototype), 'activate', this).call(this, state);
    ...
    key: 'deactivate',
    value: function deactivate(state) {
      _get(RemoveSoldAuctions.prototype.__proto__ || Object.getPrototypeOf(RemoveSoldAuctions.prototype), 'deactivate', this).call(this, state);
    ...
    value: function _start() {
      ...
      setTimeout(function () {
        if (_this4._running) {
          _core.Queue.getInstance().add('Remove sold auctions', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.t0 = _this4;
                    _context.next = 3;
                    return new _fut.Store().getTradePile();

                  case 3:
                    _context.t1 = _context.sent;
                    _context.next = 6;
                    return _context.t0._handleExpiredAuctions.call(_context.t0, _context.t1);
    ...
    key: '_handleExpiredAuctions',
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(tradepile) {
        var _this5 = this;

        var unsoldItems, lastSalePrices, j, savedSoldItems, soldItems, i, lastSalePrice, lastSalePriceKnown, lastSalePricesList, lastSalePriceO, profit, player, playerName;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                unsoldItems = tradepile.filter(function (d) {
                  return d.state !== enums.ItemState.INVALID;
                });


                if (unsoldItems.length > 0) {
                  lastSalePrices = JSON.parse(GM_getValue('auctionlastprices', '{}'));


                  for (j = 0; j < unsoldItems.length; j += 1) {
                ...
                savedSoldItems = _core.Database.getJson('items-sold', []);
                soldItems = tradepile.filter(function (d) {
                  return d.state === enums.ItemState.INVALID;
                });
                ...
                for (i = 0; i < soldItems.length; i += 1) {
                  lastSalePrice = 0;
                  lastSalePriceKnown = false;
                  lastSalePricesList = JSON.parse(GM_getValue('auctionlastprices', '{}'));
                  lastSalePriceO = lastSalePricesList[soldItems[i].id];
                  ...
                  // calculate 5% EA tax
                  profit = soldItems[i]._auction.currentBid * 0.95 - lastSalePrice;

                  if (soldItems[i].type === 'player') {
                    player = repositories.Item.getStaticDataByDefId(soldItems[i].resourceId);
                ...
                _context3.next = 8;
                return new _fut.Store().removeSoldAuctions();

              case 8:

                _core.Database.setJson('items-sold', savedSoldItems);

              case 9:

                setTimeout(function () {
                  if (_this5._running) {
                    _core.Queue.getInstance().add('Remove sold auctions', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
                      return regeneratorRuntime.wrap(function _callee2$(_context2) {
                        while (1) {
                          switch (_context2.prev = _context2.next) {
                            case 0:
                            ...
                            case 3:
                              ...
                              _context2.next = 6;
                              return _context2.t0._handleExpiredAuctions.call(_context2.t0, _context2.t1);
      ...
      function _handleExpiredAuctions(_x) {
        return _ref2.apply(this, arguments);
      }

      return _handleExpiredAuctions;
    }()
  }, {
    key: '_sendToIFTTT',
    value: function _sendToIFTTT(salePrice, profit, data) {
      var iftttMakerKey = this.getSettings()['ifttt-key'];
      if (iftttMakerKey === null) {
        return; // only send to IFTTT if the maker key is set in the settings
      }
      var url = 'https://maker.ifttt.com/trigger/market_action/with/key/' + iftttMakerKey;
      GM_xmlhttpRequest({
        method: 'POST',
      ...
      mutationRecords.forEach(function (mutation) {
        if ($(mutation.target).hasClass('DetailView') && $(mutation.target).find('.DetailPanel') && mutation.addedNodes.length > 0) {
          if ($(mutation.target).find('#downloadSoldItems').length === 0) {
            ...
            var savedSoldItems = _core.Database.getJson('items-sold', []);
            ...
            $('#downloadSoldItems').bind('click', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
              var csv;
              return regeneratorRuntime.wrap(function _callee4$(_context4) {
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      csv = RemoveSoldAuctions._convertToCsv(savedSoldItems);

                      if (csv !== null) {
                        _core.browser.downloadFile('sold-items.csv', csv);
                      } else {
                        window.alert('No sold items to download'); // eslint-disable-line no-alert
                      }
                      _core.Database.setJson('items-sold', []);
    ...
    key: '_convertToCsv',
    value: function _convertToCsv(jsonList) {
      if (jsonList === null || jsonList.length === 0) {
        return null;
      }

      var headers = Object.keys(jsonList[0]);

      var lines = '';
      jsonList.forEach(function (line) {
...
var MinBinSettings = exports.MinBinSettings = function (_SettingsEntry) {
  ...
  function MinBinSettings() {
    ...
    _this.addSetting('Amount of lowest BINs to determine minimum on', 'mean-count', '3');
    _this.addSetting('Adjust list price automatically', 'adjust-list-price', true);
    _this.addSettingUnder('adjust-list-price', 'Start price percentage (0 to 100%)', 'start-price-percentage', '90');
    _this.addSettingUnder('adjust-list-price', 'Buy now price percentage (0 to 100%)', 'buy-now-price-percentage', '110');
    return _this;
  }
...
var MinBin = function (_BaseScript) {
  ...
  _createClass(MinBin, [{
    ...
    value: function _updateListPrice(minimumBin) {
      ...
      if (settings['adjust-list-price'] && gNavManager.getCurrentScreenController()._controller._rightController._currentController._quickListPanel) {
        var quicklistpanelController = gNavManager.getCurrentScreenController()._controller._rightController._currentController._quickListPanel;
        var quicklistpanel = quicklistpanelController._view;
        ...
        if (quicklistpanelController._item) {
          ...
          var auction = quicklistpanelController._item._auction;
        ...
        var bidSpinner = quicklistpanel._bidNumericStepper;
        var buySpinner = quicklistpanel._buyNowNumericStepper;
    ...
    value: function _getSelectedItem() {
      if (gNavManager.getCurrentScreenController()._controller._listController) {
        return gNavManager.getCurrentScreenController()._controller._listController.getIterator().current();
      }

      var current = gNavManager.getCurrentScreenController()._controller._rightController._currentController._viewmodel.current();
...
exports.RelistAuctionsSettings = undefined;
...
var RelistAuctionsSettings = exports.RelistAuctionsSettings = function (_SettingsEntry) {
  _inherits(RelistAuctionsSettings, _SettingsEntry);

  function RelistAuctionsSettings() {
    _classCallCheck(this, RelistAuctionsSettings);

    var _this = _possibleConstructorReturn(this, (RelistAuctionsSettings.__proto__ || Object.getPrototypeOf(RelistAuctionsSettings)).call(this, 'relist-auctions', 'Relist expired auctions automatically', null));

    _this.addSetting('Interval in seconds', 'interval', 300);
    _this.addSetting('Relist at BIN price', 'relist-bin-price', true);
    _this.addSettingUnder('relist-bin-price', 'Start price percentage (0 to 100%)', 'relist-bin-price-start', 90);
    _this.addSettingUnder('relist-bin-price', 'Buy now price percentage (0 to 100%)', 'relist-bin-price-buynow', 110);
    return _this;
  }

  return RelistAuctionsSettings;
}(_core.SettingsEntry);

RelistAuctionsSettings.id = 'relist-auctions';

var RelistAuctions = function (_BaseScript) {
  _inherits(RelistAuctions, _BaseScript);

  function RelistAuctions() {
    _classCallCheck(this, RelistAuctions);

    var _this2 = _possibleConstructorReturn(this, (RelistAuctions.__proto__ || Object.getPrototypeOf(RelistAuctions)).call(this, RelistAuctionsSettings.id));

    _this2._logger = new _fut.Logger();
    _this2._store = new _fut.Store();
    _this2._market = new _fut.TransferMarket();
    return _this2;
  }

  _createClass(RelistAuctions, [{
    key: 'activate',
    value: function activate(state) {
      _get(RelistAuctions.prototype.__proto__ || Object.getPrototypeOf(RelistAuctions.prototype), 'activate', this).call(this, state);
    ...
    key: 'deactivate',
    value: function deactivate(state) {
      _get(RelistAuctions.prototype.__proto__ || Object.getPrototypeOf(RelistAuctions.prototype), 'deactivate', this).call(this, state);
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.t0 = _this3;
                    _context.next = 3;
                    return _this3._store.getTradePile();

                  case 3:
                    _context.t1 = _context.sent;
                    _context.next = 6;
                    return _context.t0._handleRelistAuctions.call(_context.t0, _context.t1);
    ...
    key: '_handleRelistAuctions',
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(tradepile) {
        var _this4 = this;

        var unsoldItems, settings, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, item, minimumBin, listPrice;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 6;
                return this._market.navigateToTransferList();
              ...
              case 6:
                ...
                _context3.next = 9;
                return this._market.relistAllItems();
              ...
              case 11:
                ...
                _context3.prev = 14;
                _iterator = unsoldItems[Symbol.iterator]();
              ...
              case 16:
                ...
                _context3.next = 21;
                return this._market.searchMinBuy(item, 3);

              case 21:
                minimumBin = _context3.sent;
                _context3.next = 24;
                return this._market.navigateToTransferList();

              case 24:
                listPrice = _fut.priceTiers.determineListPrice(minimumBin * (settings['relist-bin-price-start'] / 100), minimumBin * (settings['relist-bin-price-buynow'] / 100));

                // TODO: variable duration?

                _context3.next = 27;
                return this._market.listItem(item, listPrice.start, listPrice.buyNow, 1 * 60 * 60);
              ...
              case 29:
                _context3.next = 31;
                return this._market.listItem(item, item._auction.startingBid, item._auction.buyNowPrice, 1 * 60 * 60);

              case 31:
                _context3.next = 33;
                return _fut.utils.sleep(3000);
              ...
              case 54:
                ...
                this._logger.log('Cannot execute - ' + _context3.t1.message, 'Relist Expired');
                        ...
                        while (1) {
                          switch (_context2.prev = _context2.next) {
                            case 0:
                              _context2.t0 = _this4;
                              _context2.next = 3;
                              return _this4._store.getTradePile();

                            case 3:
                              _context2.t1 = _context2.sent;
                              _context2.next = 6;
                              return _context2.t0._handleRelistAuctions.call(_context2.t0, _context2.t1);
        ...
        }, _callee3, this, [[2, 54], [14, 38, 42, 50], [43,, 45, 49]]);
      }));

      function _handleRelistAuctions(_x) {
        return _ref2.apply(this, arguments);
      }

      return _handleRelistAuctions;
    }()
  }]);

  return RelistAuctions;
}(_core.BaseScript);
...
var CardInfoSettings = exports.CardInfoSettings = function (_SettingsEntry) {
  ...
  function CardInfoSettings() {
    ...
    _this.addSetting('Show contracts', 'show-contracts', 'true');
    _this.addSetting('Show fitness', 'show-fitness', 'true');
    return _this;
  }
...
var ListSizeSettings = exports.ListSizeSettings = function (_SettingsEntry) {
  ...
  function ListSizeSettings() {
    ...
    _this.addSetting('Items per page on transfer market (max 30)', 'items-per-page-transfermarket', 30);
    _this.addSetting('Items per page on club (max 90)', 'items-per-page-club', 90);
    return _this;
  }
...
var _futbinPrices = __webpack_require__(365);

var _futbinPlayerLinks = __webpack_require__(366);
...
var FutbinPrices = exports.FutbinPrices = function (_BaseScript) {
  ...
  function FutbinPrices() {
    ...
    return _possibleConstructorReturn(this, (FutbinPrices.__proto__ || Object.getPrototypeOf(FutbinPrices)).call(this, _settingsEntry.FutbinSettings.id));
  }
  ...
  _createClass(FutbinPrices, [{
    ...
    value: function _show(screen) {
      ...
      var showFutbinPricePages = ['WatchList', 'MyClubSearchFilters', 'UnassignedItems', 'TradePile', 'MyClubSearch', 'SearchResults'];
      ...
      if (showFutbinPricePages.indexOf(screen) !== -1) {
        ...
        this._intervalRunning = setInterval(function () {
          if (showFutbinPricePages.indexOf(gNavManager._currentScreen._screenId) === -1) {
            if (_this2._intervalRunning) {
              clearInterval(_this2._intervalRunning);
            }
            return;
          }
          var controller = gNavManager.getCurrentScreenController()._controller;
          ...
          var listrows = null;
          if (listController._view._list && listController._view._list._listRows && listController._view._list._listRows.length > 0) {
          ...
          var futbinUrl = 'https://www.futbin.com/18/playerPrices?player=&all_versions=' + resourceIdMapping.map(function (i) {
            return i.playerId;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 12:
                ...
                _context.t0 = gNavManager.getCurrentScreen()._screenId;
                _context.next = _context.t0 === 'UnassignedItems' ? 16 : _context.t0 === 'TradePile' ? 16 : _context.t0 === 'MyClubSearch' ? 16 : _context.t0 === 'WatchList' ? 16 : _context.t0 === 'SearchResults' ? 21 : 24;
                break;
  ...
  _createClass(FutbinPlayerLinks, [{
    ...
    value: function _getFutbinPlayerUrl(item) {
      return new Promise(function (resolve) {
        ...
        var url = 'https://www.futbin.com/search?year=18&term=' + name;
        return GM_xmlhttpRequest({
          ...
          onload: function onload(res) {
            ...
            if (exactPlayers.length > 1) {
              var version = Object.keys(enums.ItemRareType)[item.rareflag];
              if (item.rareflag < 3) {
                version = 'normal';
              }
              exactPlayers = exactPlayers.filter(function (p) {
                return p.version.toLowerCase() === version.toLowerCase();
              });
            }
            if (exactPlayers.length === 1) {
...
exports.ClubInfoSettings = undefined;
...
var ClubInfoSettings = exports.ClubInfoSettings = function (_SettingsEntry) {
  _inherits(ClubInfoSettings, _SettingsEntry);

  function ClubInfoSettings() {
    _classCallCheck(this, ClubInfoSettings);

    return _possibleConstructorReturn(this, (ClubInfoSettings.__proto__ || Object.getPrototypeOf(ClubInfoSettings)).call(this, 'club-info', 'Extract club information', null));
  }

  return ClubInfoSettings;
}(_core.SettingsEntry);

ClubInfoSettings.id = 'club-info';

var ClubInfo = function (_BaseScript) {
  _inherits(ClubInfo, _BaseScript);

  function ClubInfo() {
    _classCallCheck(this, ClubInfo);

    var _this2 = _possibleConstructorReturn(this, (ClubInfo.__proto__ || Object.getPrototypeOf(ClubInfo)).call(this, ClubInfoSettings.id));

    _this2._club = new _fut.Club();
    return _this2;
  }

  _createClass(ClubInfo, [{
    key: 'activate',
    value: function activate(state) {
      _get(ClubInfo.prototype.__proto__ || Object.getPrototypeOf(ClubInfo.prototype), 'activate', this).call(this, state);
      this._show(state.screenId);
    }
  }, {
    key: 'onScreenRequest',
    value: function onScreenRequest(screenId) {
      _get(ClubInfo.prototype.__proto__ || Object.getPrototypeOf(ClubInfo.prototype), 'onScreenRequest', this).call(this, screenId);
      this._show(screenId);
    }
  }, {
    key: 'deactivate',
    value: function deactivate(state) {
      _get(ClubInfo.prototype.__proto__ || Object.getPrototypeOf(ClubInfo.prototype), 'deactivate', this).call(this, state);
        ...
        case 'MyClubSearch':
          setTimeout(function () {
            if ($('.MyClubItemsSearchHeader').find('#download-club-info').length === 0) {
              ...
              $('#download-club-info').click(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                var players, result;
                return regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      ...
                      case 2:
                        ...
                        players = [];
                        _context.next = 7;
                        return _this3._club.getPlayers(0, 90);

                      case 7:
                        result = _context.sent;

                        players.push.apply(players, _toConsumableArray(result.players));
                      ...
                      case 18:
                        ...
                        _core.browser._downloadFile('players.csv', ClubInfo._convertJsonToCsv(players));
    ...
    key: '_convertJsonToCsv',
    value: function _convertJsonToCsv(data) {
      var items = data;
      var replacer = function replacer(key, value) {
        return value === null ? '' : value;
      }; // specify how you want to handle null values here
      var staticDataHeader = ['firstName', 'lastName', 'name', 'knownAs'];
      var header = ['concept', 'contract', 'discardValue', 'duplicateId', 'duplicateItemLoans', 'fitness', 'iconId', 'id', 'injuryGames', 'lastSalePrice', 'leagueId', 'loans', 'loyaltyBonus', 'nationId', 'pile', 'playStyle', 'preferredPosition', 'rareflag', 'rating', 'resourceGameYear', 'resourceId', 'stackCount', 'state', 'subtype', 'suspensionGames', 'teamId', 'training', 'type', 'untradeable', 'untradeableCount'];
      var otherHeaders = ['team', 'league', 'nation'];
      var staticData = function staticData(row) {
        return staticDataHeader.map(function (shFieldName) {
          return JSON.stringify(row._staticData[shFieldName], replacer);
        }).join(',');
      };
      var fields = function fields(row) {
        return header.map(function (fieldName) {
          return JSON.stringify(row[fieldName], replacer);
        }).join(',');
      };
      var team = function team(row) {
        return gLocalization.lText('global.teamFull.2018.team' + row.teamId);
      };
      var nation = function nation(row) {
        return gLocalization.lText('search.nationName.nation' + row.nationId);
      };
      var league = function league(row) {
        return gLocalization.lText('global.leagueabbr15.2018.league' + row.leagueId);
      };
      var csv = items.map(function (row) {
        return staticData(row) + ',' + fields(row) + ',' + team(row) + ',' + league(row) + ',' + nation(row);
      });
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./club-info.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./club-info.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, "#download-club-info {\n  position: absolute;\n  height: auto;\n  max-height: 100%;\n  right: 165px;\n  top: 15px; }\n  #download-club-info .btn:before {\n    background-image: none;\n    width: 0; }\n", ""]);
